            ...
            <div class="col-12">
                <div class="card shadow-sm border-0">
                    <div class="card-header bg-white border-0 py-3">
                        <h5 class="mb-0 text-secondary">Cadastrar Nova Clínica</h5>
                    </div>
                    <div class="card-body">
                        ...
                        <form method="POST" action="/clinicas-salvar">
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="telefone_1" name="telefone_1" maxlength="15" placeholder="(00) 00000-0000" required>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="telefone_2" name="telefone_2" maxlength="15" placeholder="(00) 00000-0000">
                                </div>
