<?php
/**
 * AmigoPet - Cadastro de Adotante
 * Localização: ~/App/View/dashboard/adotante_cadastro_content.php
 */
?>
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <p class="text-muted mb-0">
                    Cadastre novos adotantes
                </p>
            </div>
            
            <a href="adotante_listar.php" class="btn-voltar">
            ...
            <form method="POST" action="/dashboard/adotante/cadastrar">
                ...
                <div class="ap-section">
                    ...
                    <div class="ap-grid ap-grid-4">
                        ...
                        <div>
                            <label class="form-label" for="telefone_2">Telefone 2 <span
                ...
                <div class="ap-section">
                    ...
                    <div style="max-width: 260px;">
                        <label class="form-label" for="status">Status do Adotante</label>
