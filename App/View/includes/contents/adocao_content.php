...
// Lista animais disponíveis via DAO
...
<div class="main-content">
    <div class="container-fluid">
        ...
        <div class="search-container border">
            <div class="row align-items-center">
                ...
                <div class="col-md-4 mt-3 mt-md-0 text-md-end">
                    <span class="text-muted small fw-bold">Total: <span id="petCount" class="text-primary"><?php echo count($animaisDisponiveis); ?></span> amigos</span>
                </div>
            </div>
        </div>
        ...
        <div class="row g-4" id="petGrid">
            <?php foreach ($animaisDisponiveis as $modelPet): 
                $pet = [
                    'id' => $modelPet->__get('id'),
                    'imagem' => $modelPet->__get('foto'),
                    'nome' => $modelPet->__get('nome'),
                    'especie' => $modelPet->__get('especie_nome'),
                    'raca' => $modelPet->__get('racas'),
                    'sexo' => $modelPet->__get('sexo'),
                    'descricao' => $modelPet->__get('descricao'),
