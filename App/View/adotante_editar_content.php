        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <p class="page-subtitle">
                    Atualize as informações do adotante
                </p>
            </div>

            <a href="/dashboard/adotante/listar" class="btn-voltar">
            ...
            <form method="POST" action="/dashboard/adotante/alterar">
                ...
                <div class="ap-section">
                    ...
                    <div class="ap-grid ap-grid-4">
                        ...
                        <div>
                            <label class="ap-label" for="data_nascimento">
                                Data de Nascimento
                            </label>
                        ...
                        <div>
                            <label class="ap-label" for="telefone_1">
                                Telefone 1
                            </label>
                        ...
                        <div>
                            <label class="ap-label" for="telefone_2">
                                Telefone 2
                            </label>
                ...
                <div class="ap-section">
                    ...
                    <div class="ap-grid ap-grid-4">
                        ...
                        <div class="ap-col-2">
                            <label class="ap-label" for="logradouro">
                                Logradouro
                            </label>
                        ...
                        <div>
                            <label class="ap-label" for="numero">
                                Número
                            </label>
                        ...
                        <div>
                            <label class="ap-label" for="complemento">
                                Complemento
                            </label>
                        ...
                        <div>
                            <label class="ap-label" for="bairro">
                                Bairro
                            </label>
                        ...
                        <div>
                            <label class="ap-label" for="cidade">
                                Cidade
                            </label>
                        ...
                        <div>
                            <label class="ap-label" for="estado">
                                UF
                            </label>
                ...
                <div class="ap-section">
                    ...
                    <div style="max-width: 260px;">
                        ...
                        <label class="ap-label" for="status">
                            Status do Adotante
                        </label>

                        <select class="ap-select" id="status" name="status">
