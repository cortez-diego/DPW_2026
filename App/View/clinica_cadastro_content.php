<?php
/**
 * AmigoPet - Cadastro de clinia
 * Localização: ~/App/View/dashboard/clinica_cadastro_content.php
 */
?>
...
<div class="main-content">
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h1 class="h3 mb-1 fw-bold" style="color:#4F4F4F;">Cadastro de Clínica Veterinária</h1>
                <p class="text-muted mb-0">Preencha os dados para cadastrar a clínica</p>
            </div>
            <a href="clinica_listar.php" class="btn-voltar">
        ...
        <div class="ap-form-card">
            <form method="POST" action="/dashboard/clinica/cadastrar" novalidate>

                <!-- Dados da Clínica -->
                <div class="ap-section">
                    <div class="ap-section-title">Dados da Clínica</div>
                    <div class="ap-grid ap-grid-4">
                        <div class="ap-col-2">
                            <label class="form-label" for="nome">Nome da clínica <span class="req">*</span></label>
                        ...
                        <div>
                            ...
                            <input type="email" class="form-control" id="email" name="email" maxlength="255" placeholder="contato@clinica.com.br" required>
                        </div>
                        <div>
                            <label class="form-label" for="telefone_1">Telefone 1 <span class="req">*</span></label>
                            <input type="text" class="form-control" id="telefone_1" name="telefone_1" maxlength="20" placeholder="(00) 00000-0000" required>
                        </div>
                        <div>
                            <label class="form-label" for="telefone_2">Telefone 2 <span class="opt">(opcional)</span></label>
                            <input type="text" class="form-control" id="telefone_2" name="telefone_2" maxlength="20" placeholder="(00) 00000-0000">
                        </div>
                    </div>
                </div>
                ...
                <div class="ap-section">
                    ...
                    <div class="ap-grid ap-grid-4">
                        ...
                        <div class="ap-col-2">
                            <label class="form-label" for="logradouro">Logradouro <span class="req">*</span></label>
                        ...
                        <div>
                            <label class="form-label" for="complemento">Complemento <span class="opt">(opcional)</span></label>
                        ...
                        <div>
                            <label class="form-label" for="estado">UF <span class="req">*</span></label>
                ...
                <div style="display:flex; gap: 10px; padding-top: 0.5rem;">
                    ...
                    <a href="clinica_listar.php" class="ap-btn-secondary">
                        <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
