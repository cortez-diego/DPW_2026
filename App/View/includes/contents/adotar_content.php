...
$selectedPet = null;
foreach ($animaisSimulados as $pet) {
    if ($pet['id'] === $petId) {
        $selectedPet = $pet;
        break;
    }
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($formValues['nome']) || empty($formValues['cpf']) || empty($selectedPet)) {
        ...
        $successMessage = "Obrigado, {$formValues['nome']}! Sua solicitação para adotar o {$selectedPet['nome']} foi registrada com sucesso. Nosso time entrará em contato em breve.";
    }
}
?>
