...
// Últimos animais adicionados (buscar no banco)
use App\DAO\AnimalDAO;
$animalDao = new AnimalDAO();
$all = $animalDao->listar();
// ordenar por id desc
usort($all, function($a, $b){ return $b->__get('id') <=> $a->__get('id'); });
$latestAdded = array_slice($all, 0, 5);
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-sm align-middle">
                                ...
                                <tbody>
                                    <?php foreach ($latestAdded as $m): ?>
                                    <tr>
                                        <td><img src="<?php echo htmlspecialchars($m->__get('foto')); ?>" style="width:56px;height:40px;object-fit:cover;border-radius:6px;" onerror="this.src='https://via.placeholder.com/56'"/></td>
                                        <td class="fw-bold"><?php echo htmlspecialchars($m->__get('nome')); ?></td>
                                        <td><?php echo htmlspecialchars($m->__get('especie_nome')); ?></td>
                                        <td><?php echo htmlspecialchars($m->__get('racas')); ?></td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
