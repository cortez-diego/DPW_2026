...
const styles = StyleSheet.create({
  ...
  timelineLabel: { fontFamily: typography.fontFamily.body, fontSize: 9, color: colors.secondary, textAlign: 'center' },
  ...
  secao: { backgroundColor: colors.bg, borderRadius: 12, padding: spacing.md, marginBottom: spacing.sm },
