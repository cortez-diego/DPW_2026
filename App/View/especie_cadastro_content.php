 ...
 * Localização: ~/App/View/dashboard/especie_cadastro_content.php
 */
?>
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <p class="text-muted mb-0">
                    Cadastre uma nova espécie
                </p>
            </div>
            
            <a href="especie_listar.php" class="btn-voltar">
        ...
        <div class="ap-form-card">
            <form method="POST" action="/dashboard/especie/cadastrar">
                ...
                <div class="ap-section">
                    <div class="ap-section-title">Dados da Espécie</div>
                ...
                <div style="display:flex; gap: 10px; padding-top: 0.5rem;">
                    ...
                    <a href="/dashboard/especie/listar" class="ap-btn-secondary">
                        <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                            stroke-width="2">
